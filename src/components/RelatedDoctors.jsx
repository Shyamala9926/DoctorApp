...
function RelatedDoctors() {
    ...
    return (
        <div className="flex flex-col items-center gap-6 my-16 text-gray-900 px-4 md:px-10">
            ...
            <p className="text-center text-sm text-gray-600 sm:w-2/3">
            ...
            {relDoc.length > 5 && (
                <button className="bg-blue-500 text-white px-8 py-3 rounded-full mt-8 hover:bg-blue-600 transition">
                    More
                </button>
            )}
        </div>
